...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    createProduct: function createProduct(e) {
      ...
      e.preventDefault();
      var validate = this.validateCreateProductForm();

      if (validate) {
        var srvUrl = this.isEditMode ? 'api/products/update/' + this.productid : 'api/products';
        ...
        axios({
          ...
          if (res.data.status == 'error') {
            ...
            for (var key in errorMsg) {
              if (errorMsg.hasOwnProperty(key)) {
                _this.errors[key].type = 'is-invalid';
                _this.errors[key].message = errorMsg[key][0];
              }
            }
          ...
          if (res.status) {
            var successMsg = _this.isEditMode ? 'Product Details Updated Successfully' : 'Product Created!';
            _this.alertType = 'success';
            _this.alertMessage = successMsg;
            _this.isAlertActive = true;
    ...
    validateCreateProductForm: function validateCreateProductForm() {
      var that = this;
      var isError = false;
      that.fieldList.map(function (field) {
    ...
    resetForm: function resetForm() {
      this.productName = "", this.new_arrival = "0", this.description = "", this.stock = "", this.sku = "", this.price = "", this.image = "", document.getElementById("image").value = "";
      this.attachment = null, this.isEditMode = false;
    },
    editProductDetails: function editProductDetails(id) {
      var _this2 = this;

      axios.get("api/products/" + id).then(function (response) {
        if (response.data.status == 'success') {
          var data = response.data.data;
          _this2.productName = data.name, _this2.new_arrival = data.new_arrival, _this2.description = data.description, _this2.stock = data.stock, _this2.sku = data.sku, _this2.image = data.image, _this2.price = data.price, _this2.productid = data.id, _this2.isEditMode = true;
        }
      });
    },
    cancelProductForm: function cancelProductForm() {
...
/***/ "./node_modules/babel-loader/lib/index.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Export.vue?vue&type=script&lang=js&":
/*!*****************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib??ref--4-0!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Export.vue?vue&type=script&lang=js& ***!
  \*****************************************************************************************************************************************************************/
/*! exports provided: default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  methods: {
    ...
    exportProducts: function exportProducts() {
      ...
      axios({
        ...
        link.href = url;
        link.setAttribute('download', 'products.' + _this.exportType);
    ...
    uploadData: function uploadData() {
      ...
      axios.post('api/importFile', formData).then(function (response) {
        if (response.status) {
          _this2.showImportBox = false;
          _this2.attachment = null;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Export__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Export */ "./resources/js/components/Export.vue");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  components: {
    Export: _Export__WEBPACK_IMPORTED_MODULE_0__["default"],
    ...
    loadProducts: function loadProducts(page) {
      ...
      axios.get("api/products/?page=" + page).then(function (response) {
        ...
        if (response.data.total <= 0) {
          _this.productsNotAvailable = true;
        }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    initializeError: function initializeError() {
      var _this = this;
    ...
    handleSubmit: function handleSubmit(e) {
      ...
      this.fields.forEach(function (field, index) {
        if (_this2[field] == "") {
          _this2.errors[field].type = "is-danger";
          _this2.errors[field].message = field + ' should not empty.';
          isError = true;
        }
      });
      ...
      axios.post('api/register', {
        ...
        if (localStorage.getItem('bigStore.jwt') != null) {
          ...
          _this2.$router.push(nextUrl != null ? nextUrl : '/products');
        }
      }).catch(function (error) {
        if (error.response.data.error.name) {
          _this2.errors.name.type = 'is-danger';
          _this2.errors.name.message = error.response.data.error.name[0];
        }

        if (error.response.data.error.email) {
          _this2.errors.email.type = 'is-danger';
          _this2.errors.email.message = error.response.data.error.email[0];
        }

        if (error.response.data.error.password) {
          _this2.errors.password.type = 'is-danger';
          _this2.errors.password.message = error.response.data.error.password[0];
        }

        if (error.response.data.error.c_password) {
          _this2.errors.c_password.type = 'is-danger';
          _this2.errors.c_password.message = error.response.data.error.c_password[0];
        }
      });
    }
  }
...
var render = function() {
  ...
  return _c("div", { staticClass: "alert-div" }, [
    _vm.alertType
      ? _c(
          "div",
          { class: "alert alert-" + _vm.alertType, attrs: { role: "alert" } },
          [
            _c("Strong", [_vm._v(_vm._s(_vm.alertType.toUpperCase()) + "!")]),
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/CreateProduct.vue?vue&type=template&id=763eab10&scoped=true&":
/*!****************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/CreateProduct.vue?vue&type=template&id=763eab10&scoped=true& ***!
  \****************************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c(
    ...
    [
      ...
      _c("div", { staticClass: "col-md-10" }, [
        _c("div", { staticClass: "addProductForm" }, [
          _c(
            "form",
            {
              attrs: { action: "#", id: "productForm", method: "POST" },
              ...
              _c("div", { staticClass: "row form-group" }, [
                ...
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                    ...
                    class: "form-control " + _vm.errors.productName.type,
                    attrs: {
                      type: "text",
                      name: "productName",
                      id: "productName"
                  ...
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.productName.message))
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row form-group" }, [
                ...
                _c("div", { staticClass: "col-md-9" }, [
                  _c("textarea", {
                    ...
                    class: "form-control " + _vm.errors.description.type,
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.description.message))
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row form-group" }, [
                ...
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                    ...
                    class: "form-control " + _vm.errors.stock.type,
                    attrs: { type: "number", name: "stock", id: "stock" },
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.stock.message))
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row form-group" }, [
                _c("label", { staticClass: "col-md-3" }, [_vm._v("Price:")]),
                _vm._v(" "),
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                    directives: [
                    ...
                    class: "form-control " + _vm.errors.price.type,
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.price.message))
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row form-group" }, [
                _c("label", { staticClass: "col-md-3" }, [_vm._v("Image:")]),
                _vm._v(" "),
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.image.message))
                  ])
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "row form-group" }, [
                _c("label", { staticClass: "col-md-3" }, [_vm._v("SKU:")]),
                _vm._v(" "),
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                    directives: [
                    ...
                    class: "form-control " + _vm.errors.sku.type,
                    attrs: { type: "text", name: "sku", id: "sku" },
                  ...
                  _vm._v(" "),
                  _c("span", { staticClass: "text-danger" }, [
                    _vm._v(_vm._s(_vm.errors.sku.message))
                  ])
                ])
              ]),
              _vm._v(" "),
                  ...
                  _c(
                    ...
                    [
                      _c("input", {
                        directives: [
                          {
                            name: "model",
                            rawName: "v-model",
                            value: _vm.new_arrival,
                            expression: "new_arrival"
                          }
                        ],
                        attrs: {
                          type: "radio",
                        ...
                        domProps: { checked: _vm._q(_vm.new_arrival, "0") },
                        on: {
                  ...
                  _c(
                    ...
                    [
                      _c("input", {
                        ...
                        domProps: { checked: _vm._q(_vm.new_arrival, "1") },
                        on: {
                          change: function($event) {
                            _vm.new_arrival = "1"
                          }
              ...
              _c("div", { staticClass: "row form-group" }, [
                ...
                _c("div", { staticClass: "col-md-9" }, [
                  _c("input", {
                    ...
                    attrs: { type: "hidden", name: "productid" },
                  ...
                  _c(
                    ...
                    [_vm._v(_vm._s(_vm.isEditMode ? "Update" : "Save"))]
                  ),
                  _vm._v(" "),
                  _c(
                    "button",
                    {
                      ...
                      attrs: { type: "button" },
                      on: { click: _vm.cancelProductForm }
                    },
                    [_vm._v("Cancel")]
                  )
                ])
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true&":
/*!*********************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true& ***!
  \*********************************************************************************************************************************************************************************************************************/
/*! exports provided: render, staticRenderFns */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
  ...
  return _c("div", [
    _c("div", [
      ...
      _c("input", {
        ...
        attrs: { type: "radio", name: "exportType", value: "csv" },
        domProps: { checked: _vm._q(_vm.exportType, "csv") },
        on: {
          change: function($event) {
            _vm.exportType = "csv"
          }
      ...
      _c("input", {
        ...
        attrs: { type: "radio", name: "exportType", value: "xlsx" },
        domProps: { checked: _vm._q(_vm.exportType, "xlsx") },
        on: {
          change: function($event) {
            _vm.exportType = "xlsx"
          }
    ...
    _vm.showImportBox
      ? _c("div", [
          _c("input", {
            attrs: { type: "file", name: "sampleFile", id: "sampleFile" },
            on: { change: _vm.attachFile }
          }),
          _vm._v(" "),
          _c(
          ...
          ? _c(
              ...
              [
                _c(
                  "H4",
                  [
                    _vm._v("You Don't have Product Yet, Click on "),
                    _c(
                      "router-link",
                      { attrs: { to: { name: "add-products" } } },
                      [_vm._v("Add product\n                    ")]
                    ),
                    _vm._v(" Link to add new Product")
                  ],
                  1
                )
              ],
              ...
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-6" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    class: _vm.errors.name.type !== "" ? "is-invalid" : "",
                    attrs: {
                      id: "name",
                      type: "text",
                      required: "",
                  ...
                  _c(
                    ...
                    [_c("strong", [_vm._v(_vm._s(_vm.errors.name.message))])]
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-6" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    class: _vm.errors.email.type !== "" ? "is-invalid" : "",
                  ...
                  _c(
                    ...
                    [_c("strong", [_vm._v(_vm._s(_vm.errors.email.message))])]
                  )
                ])
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-6" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    class: _vm.errors.password.type !== "" ? "is-invalid" : "",
                    attrs: { id: "password", type: "password", required: "" },
                    domProps: { value: _vm.password },
                    on: {
                      input: function($event) {
              ...
              _c("div", { staticClass: "form-group row" }, [
                ...
                _c("div", { staticClass: "col-md-6" }, [
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    class:
                      _vm.errors.c_password.type !== "" ? "is-invalid" : "",
                    attrs: {
                      id: "password-confirm",
                      type: "password",
                      required: ""
                  ...
                  _c(
                    ...
                    [
                      _c("strong", [
                        _vm._v(_vm._s(_vm.errors.c_password.message))
                      ])
                    ]
                  )
                ])
...
/* harmony import */ var _components_Products__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/Products */ "./resources/js/components/Products.vue");
/* harmony import */ var _components_CreateProduct__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./components/CreateProduct */ "./resources/js/components/CreateProduct.vue");
...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_1__["default"]({
  ...
  routes: [{
    ...
    path: '/add-products',
    name: 'add-products',
    component: _components_CreateProduct__WEBPACK_IMPORTED_MODULE_6__["default"],
    meta: {
      requiresAuth: true
    }
  }, {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreateProduct_vue_vue_type_template_id_763eab10_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_CreateProduct_vue_vue_type_template_id_763eab10_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });



/***/ }),

/***/ "./resources/js/components/Export.vue":
/*!********************************************!*\
  !*** ./resources/js/components/Export.vue ***!
  \********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Export.vue?vue&type=template&id=f2107042&scoped=true& */ "./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true&");
/* harmony import */ var _Export_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Export.vue?vue&type=script&lang=js& */ "./resources/js/components/Export.vue?vue&type=script&lang=js&");
/* empty/unused harmony star reexport *//* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  ...
  _Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  "f2107042",
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "resources/js/components/Export.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./resources/js/components/Export.vue?vue&type=script&lang=js&":
/*!*********************************************************************!*\
  !*** ./resources/js/components/Export.vue?vue&type=script&lang=js& ***!
  \*********************************************************************/
/*! exports provided: default */
...
/***/ "./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true&":
/*!***************************************************************************************!*\
  !*** ./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true& ***!
  \***************************************************************************************/
/*! exports provided: render, staticRenderFns */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!../../../node_modules/vue-loader/lib??vue-loader-options!./Export.vue?vue&type=template&id=f2107042&scoped=true& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js?!./node_modules/vue-loader/lib/index.js?!./resources/js/components/Export.vue?vue&type=template&id=f2107042&scoped=true&");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Export_vue_vue_type_template_id_f2107042_scoped_true___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
__webpack_require__(/*! G:\WinNMP\WWW\test-product\product-inventory\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! G:\WinNMP\WWW\test-product\product-inventory\resources\sass\app.scss */"./resources/sass/app.scss");
